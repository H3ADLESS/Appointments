...
<main>
    ...
    <div class="mdl-grid">
        <div class="mdl-cell mdl-cell--12-col">
            <h4>Dein Termin "${this.appointment.subject}"</h4>
        </div>
        ...
        <div class="mdl-cell mdl-cell--12-col">
            <a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="${createLink(controller: 'appointment', action: 'list')}">
                Zurück
            </a>
